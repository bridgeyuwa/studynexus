...
**Purpose.** Consolidates comparison and decision-support material.
...
- **CAP008 — Comparison**: Support side-by-side or contextual comparison of relevant education choices using comparable facts. _Scope: MVP — defined; strategic status: IN._
...
- **CON047 — Comparison**: A decision-support behavior that places relevant education options or facts side by side using comparable information.
