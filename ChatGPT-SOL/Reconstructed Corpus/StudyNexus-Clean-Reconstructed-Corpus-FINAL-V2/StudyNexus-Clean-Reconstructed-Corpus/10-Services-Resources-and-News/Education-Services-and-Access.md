---
corpus_id: COR-SVC-001
document_kind: SOURCE_RECONSTRUCTION
title: "Education Services and Access"
category: services-resources-and-news
...
# Education Services and Access

**Purpose.** Consolidates Education Services & Access material; Organization remains unresolved rather than universalized.
...
- Organization remains an unresolved vocabulary/modeling question; it is not a universal product abstraction.

## Historical evolution and source evidence

### SRC-0002 — Education Services & Access — Product Discovery Additions

- **Historical path:** `Education Services & Access - Product Discovery Additions 03-09-2026.md`
- **Period/version:** 2026-09-03
- **Status in working corpus:** CURRENT_SUPPORTING
- **Near-duplicate family:** NONE
- **Contribution:** Status: Approved Product Discovery Addition Scope: Education-Related Service Discovery, Service Locations, Access Points, Study Mobility, Testing, Credential Services and Directions StudyNexus should help users discover where and how they can complete education-related tasks. It should not become the operational system of the organization Key sections: Model:; Do not model:.
...
|---|---|---|---:|---|
| SRC-0002 | `Education Services & Access - Product Discovery Additions 03-09-2026.md` | `39d6828ca1a84fd111321c1d05b58dd11b4e084fa670d634f4c6d1d7df224746` | 1 |  |
