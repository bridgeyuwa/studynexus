...
|---|---|---|
| `COR-*` current-supporting product dossiers | Navigation, consolidated supporting evidence, historical context | No |
...
The working corpus supplies detailed evidence and evolution around product definition, journeys, programme/offering classification, admissions, scholarships, catchment/ELDS, examinations, News, Education Services & Access, provenance/information quality, and other current Product Discovery areas.
