---
corpus_id: COR-ADM-001
title: "Admissions and Admission Cycles"
...
# Admissions and Admission Cycles

**Purpose.** Consolidates admissions information and historical modelling evidence.
...
### SRC-0493 — StudyNexus — Domain Discovery: Topic 2 Revision

- **Historical path:** `STUDYNEXUS-V4.6-SOURCE-CORPUS/PRE-IMPLEMENTATION-BASELINE-V2/archive/12-domain-discovery-topic2-revision.md`
- **Period/version:** V4.6 period
- **Status in working corpus:** HISTORICAL
- **Near-duplicate family:** NONE
- **Contribution:** Scope: Aggregate boundary decisions only (DD2-1, DD2-2, DD2-3 revised; DD2-4 through DD2-8 new) Unchanged: Relationship analysis, lifecycles, temporal behaviour, identity rules, cardinality, domain interactions — accepted as-is from original Topic 2 This revision applies the pragmatic DDD philosophy of Laravel Beyond CRUD (Brent Roose & F Key sections: Guiding Philosophy; DD2-1 (Revised): Aggregate Root Classifications; Evaluation Criteria; Evaluation Matrix; Aggregate Root Justifications; Educational Institution — Aggregate Root.
...
|---|---|---|---:|---|
| SRC-0493 | `STUDYNEXUS-V4.6-SOURCE-CORPUS/PRE-IMPLEMENTATION-BASELINE-V2/archive/12-domain-discovery-topic2-revision.md` | `0ed1e8597ec733b16ca8f0951550125cac027815fda817bf2671b8e3626ac3c3` | 8 |  |
