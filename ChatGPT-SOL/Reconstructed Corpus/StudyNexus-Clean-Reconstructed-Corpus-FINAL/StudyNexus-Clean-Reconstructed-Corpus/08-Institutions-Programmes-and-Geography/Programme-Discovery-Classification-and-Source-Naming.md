---
corpus_id: COR-INST-001
title: "Programme Discovery, Classification and Source Naming"
category: institutions-programmes-and-geography
subcategory: programme-discovery
...
# Programme Discovery, Classification and Source Naming

**Purpose.** Detailed supporting dossier for source-faithful offerings, optional discovery classification and jurisdictional classification schemes.
...
- **CON043 — Discovery**: Exploration of education possibilities, alternatives, combinations and related information when the user does not already know the exact target.

### Relevant current resolutions

- **R013**: Remain excluded from current MVP. StudyNexus may consume provider/authority evidence without offering provider self-service.
- **R014**: Nigeria-first public rollout remains current. Multi-country public launch is excluded from current delivery, while jurisdiction-aware internationalization semantics is a current cross-cutting product principle/constraint rather than an ordinary standalone capability.
...
No historical source was assigned as the primary source for this dossier. Current navigation is derived from the accepted final registers and related reconstructed dossiers.
